...
export const PROJECT_DETAILS: Record<string, any> = {
  ...
  'ai-governance': {
    ...
    visualEvidence: [
      {
        title: 'Governance Org Map',
        type: 'Operating Organization',
        caption: 'Governance/Factory 역할을 분리하고 PM 중심 실행 라우팅을 명확히 표현한 조직도',
        competency: 'Cross-functional routing + ownership clarity',
        lanes: [
          ['CEO', 'PM', 'SWE'],
          ['CTO', 'Research', 'Aurora Ops'],
          ['CMO', 'pure-flon.com', 'Factory Hub']
        ],
        checkpoints: ['Role ownership', 'Routing authority', 'Escalation path']
      },
      {
        title: 'System Diagram (Governance → Factory → Public)',
        type: 'Execution Architecture',
        caption: 'private orchestration에서 public surface 출하까지의 3-Tier 연결 다이어그램',
        competency: 'Pipeline reliability + product shipping',
        lanes: [
          ['Governance Root', 'Plan/Review Gates', 'Approved Spec'],
          ['Factory Execution', 'Build/Test/Verify', 'Release Artifact'],
          ['pure-flon.com Surface', 'Product/RFQ/SaaS/Tools', 'External Proof']
        ],
        checkpoints: ['draft', 'shadow', 'canary', 'active']
      },
      {
        title: 'Governance Wireframe Board',
        type: 'Decision & Quality Board',
        caption: '계획-실행-검증-핸드오프를 한 화면에서 추적하는 운영 와이어프레임',
        competency: 'Quality gate enforcement + auditability',
        lanes: [
          ['Spec Queue', 'Execution Queue', 'Verification Queue'],
          ['Blocked', 'In Progress', 'Done'],
          ['Evidence Link', 'Run ID', 'Owner']
        ],
        checkpoints: ['Input validation', 'Evidence quality', 'Safety policy', 'Handoff completeness']
      }
    ],
    results: {
  ...
  'pure-flon-com': {
    ...
    gallery: [
      ...
      {
        title: 'B2B 제품 상세',
        image: withBase('/assets/images/projects/pure-flon-com/product-esd-pfa-tube.png'),
      ...
      {
        title: 'RFQ / Quote 퍼널',
        image: withBase('/assets/images/projects/pure-flon-com/quote.png'),
      ...
      },
      {
        ...
        image: withBase('/assets/images/projects/pure-flon-com/saas-ai-ops-autopilot.png'),
      ...
      },
      {
        ...
        image: withBase('/assets/images/projects/pure-flon-com/tools.png'),
    ...
    visualEvidence: [
      {
        title: 'Public Surface Wireframe',
        type: 'Home → Product → RFQ → SaaS → Tools',
        caption: '고객 인입부터 제품 확인, 문의 전환, 가격 검토, 도구 확장까지의 public funnel wireframe',
        competency: 'End-to-end funnel composition + product packaging',
        lanes: [
          ['Home', 'Product Detail', 'RFQ Form'],
          ['RFQ Follow-up', 'SaaS Pricing', 'Tools Distribution']
        ],
        checkpoints: ['Awareness', 'Evaluation', 'Lead capture', 'Monetization', 'Retention']
      }
    ],
